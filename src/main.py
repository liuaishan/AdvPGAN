...
# hyperparameter
flags = tf.app.flags
flags.DEFINE_integer("epoch", 500, "epoch number to train")
...
flags.DEFINE_float("alpha", 0.3, "parameter alpha")
flags.DEFINE_float("beta", 0.3, "parameter beta")
...
flags.DEFINE_float("tv_weight", 0.001, "weight for total variance loss")
flags.DEFINE_string("target_model_dir", "/media/dsgDisk/dsgPrivate/liuaishan/GTSRB/model/test/GTSRB_best_test", "data directory")
flags.DEFINE_string("checkpoint_dir", "/media/dsgDisk/dsgPrivate/liuaishan/AdvpGAN/tv_checkpoint", "directory to save model")
...
def main(_):
    ...
    model = AdvPGAN(sess, batch_size=FLAGS.batch_size, image_size=FLAGS.image_size,
                    ...
                    base_patch_num=FLAGS.base_patch_num, tv_weight=FLAGS.tv_weight,
