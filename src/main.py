...
# hyperparameter
flags = tf.app.flags
flags.DEFINE_integer("epoch", 300, "epoch number to train")
...
flags.DEFINE_float("base_patch_num", 8, "base number of patch to augment")
flags.DEFINE_float("tv_weight", 0.0001, "weight for total variance loss")
flags.DEFINE_string("target_model_dir", "/media/dsgDisk/dsgPrivate/liuaishan/GTSRB/model/test/GTSRB_best_test", "data directory")
flags.DEFINE_string("checkpoint_dir", "/media/dsgDisk/dsgPrivate/liuaishan/AdvpGAN/checkpoint_603_untargeted", "directory to save model")
